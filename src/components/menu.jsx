      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="h-[95vh] trans origin-right w-[100vw] *:w-full *:text-center md:w-96 absolute top-[48px] right-0 pt-14 flex flex-col gap-2 border border-stone-50/10 bg-stone-900 rounded-sm"
          >
            <div
